...
export default function SupportPage() {
  ...
  const maintenanceRequests = [
    {
      ...
      description:
        language === "ar" ? "تسريب في الحمام الرئيسي" : "Leak in main bathroom",
      status: "new",
      priority: "high",
  ...
  const supportTickets = [
    ...
    },
    {
      ...
      subject:
        language === "ar"
          ? "طلب تغيير في التشطيبات"
          : "Request for finishing changes",
  ...
  const serviceReports = [
    {
      ...
      workDone:
        language === "ar"
          ? "تنظيف وصيانة وحدة التكييف"
          : "Cleaned and serviced AC unit",
      rating: 5,
      feedback:
        language === "ar" ? "خدمة ممتازة وسريعة" : "Excellent and fast service",
    },
    {
      id: 2,
      ticketNumber: "MT-2024-001",
      ...
      workDone:
        language === "ar"
          ? "إصلاح التسريب وتغيير الأنابيب"
          : "Fixed leak and replaced pipes",
      rating: 4,
  ...
  const tabs = [
    ...
    {
      id: "tickets",
      label: language === "ar" ? "تذاكر الدعم" : "Support Tickets",
    },
    {
      id: "reports",
      label: language === "ar" ? "تقارير الخدمة" : "Service Reports",
    },
    {
      id: "ratings",
      label: language === "ar" ? "تقييمات العملاء" : "Customer Ratings",
    },
  ];
          ...
          <div>
            ...
            <p className="text-stone-gray mt-1">
              {language === "ar"
                ...
                : "Manage maintenance requests and technical support"}
            </p>
          </div>
            ...
            <div className="bg-obsidian/50 backdrop-blur-sm rounded-xl p-8 border border-desert-gold/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-stone-gray/10 rounded-lg p-6 text-center">
                  ...
                  <p className="text-stone-gray text-sm">
                    {language === "ar" ? "عملاء راضون" : "satisfied customers"}
                  </p>
                </div>
              </div>
                ...
                {serviceReports.map((report, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-4 rtl:space-x-reverse">
                      ...
                      <div>
                        <h4 className="text-elegant-white font-medium">
                          {report.client}
                        </h4>
                        <p className="text-stone-gray text-sm">
                          {report.serviceDate}
        ...
        >
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <SelectContext
                  options={[
                    ...
                    {
                      value: "plumbing",
                      label: { ar: "سباكة", en: "Plumbing" },
                    },
                    {
                      value: "electrical",
                      label: { ar: "كهرباء", en: "Electrical" },
                    },
              ...
              <FormField
                label={language === "ar" ? "المكلف بالمهمة" : "Assign To"}
              >
                <SelectContext
                  options={[
                    { value: "all", label: { ar: "الكل", en: "All" } },
                    {
                      value: "mohammed",
                      label: { ar: "محمد الفني", en: "Mohammed Tech" },
                    },
                    {
                      value: "ali",
                      label: { ar: "علي الكهربائي", en: "Ali Electrician" },
                    },
                    {
                      value: "saad",
                      label: { ar: "سعد التكييف", en: "Saad AC Tech" },
                    },
                  ]}
                  value={""}
                  onChange={() => {}}
            ...
            <FormField
              label={language === "ar" ? "وصف المشكلة" : "Issue Description"}
              required
            >
              <textarea
                rows={4}
        ...
        >
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <SelectContext
                  options={[
                    ...
                    ...maintenanceRequests.map((request) => ({
                      ...
                      label: {
                        ar: `${request.ticketNumber} - ${request.client}`,
                        en: `${request.ticketNumber} - ${request.client}`,
                      },
                    })),
                  ]}
                  value={""}
              ...
              <FormField
                label={language === "ar" ? "الفني المنفذ" : "Technician"}
                required
              >
                <SelectContext
                  options={[
              ...
              <FormField
                label={language === "ar" ? "وقت الخدمة" : "Service Time"}
                required
              >
                <input
                  type="time"
            ...
            <FormField
              label={language === "ar" ? "الأعمال المنجزة" : "Work Completed"}
              required
            >
              <textarea
                rows={4}
