...
export default function TeamPage() {
  ...
  const activityLog = [
    ...
    },
    {
      ...
      details:
        language === "ar"
          ? "أضافت عميل جديد: سعد الدوسري"
          : "Added new customer: Saad Al-Dosari",
    ...
    },
    {
      ...
      action:
        language === "ar" ? "تحديث طلب صيانة" : "Updated maintenance request",
      details:
        language === "ar"
          ? "حدث حالة الطلب MT-2024-001 إلى مكتمل"
          : "Updated request MT-2024-001 status to completed",
  ...
  const tabs = [
    ...
    {
      id: "permissions",
      label: language === "ar" ? "الصلاحيات" : "Role Permissions",
    },
    {
      id: "activity",
    ...
    {
      id: "audit",
      label: language === "ar" ? "سجل تسجيل الدخول" : "Login Audit",
    },
  ];
    ...
    },
    {
      ...
      render: (value: string | null) => (
        <span className="text-stone-gray">
          {value || (language === "ar" ? "لا يزال متصل" : "Still active")}
        </span>
      ),
    },
    {
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {Object.entries(permissions).map(([key, value]) => (
                      <tr
                        key={key}
                        className="border-b border-desert-gold/10 hover:bg-stone-gray/5"
                      >
              ...
              >
                <SelectContext
                  options={[
                    {
                      value: "unassigned",
                      label: { ar: "اختر القسم", en: "Select Department" },
                    },
                    {
                      value: "management",
